...
{
public:
	struct FFortClientAnnouncementData_Tutorial  TutorialData;                                      // 0x0(0x128)(BlueprintVisible, BlueprintReadOnly, Parm)
...
{
public:
	struct FFortClientAnnouncementData_Tutorial  FortClientAnnouncementData_Tutorial;               // 0x0(0x128)(BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
	enum class ESlateVisibility                  ReturnValue;                                       // 0x128(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         Temp_bool_Variable;                                // 0x129(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	enum class ESlateVisibility                  Temp_byte_Variable;                                // 0x12A(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_BooleanOR_ReturnValue;                    // 0x12B(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	enum class ESlateVisibility                  Temp_byte_Variable2;                               // 0x12C(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	struct FFortClientAnnouncementData_Tutorial  TutorialData;                                      // 0x0(0x128)(BlueprintVisible, BlueprintReadOnly, Parm)
	class UOverlaySlot*                          ContentBoxSlot;                                    // 0x128(0x8)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FFortClientAnnouncementData_Tutorial  LocalTutorialData;                                 // 0x130(0x128)(Edit, BlueprintVisible)
	bool                                         CallFunc_TextIsEmpty_ReturnValue;                  // 0x258(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_Not_PreBool_ReturnValue;                  // 0x259(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	enum class ESlateVisibility                  CallFunc_GetLightboxVisibility_ReturnValue;        // 0x25A(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_EqualEqual_TextText_ReturnValue;          // 0x25B(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	int32                                        CallFunc_Array_Add_ReturnValue;                    // 0x25C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UOverlaySlot*                          CallFunc_SlotAsOverlaySlot_ReturnValue;            // 0x260(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	class UCommonUserWidget*                     NewLine;                                           // 0x20(0x8)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	struct FFortClientAnnouncementData_Tutorial  TutorialData;                                      // 0x0(0x128)(BlueprintVisible, BlueprintReadOnly, Parm)
	bool                                         bShow;                                             // 0x128(0x1)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
public:
	...
	struct FFortClientAnnouncementData_Tutorial  K2Node_MakeStruct_FortClientAnnouncementData_Tutorial; // 0x18(0x128)()
	class UObject*                               K2Node_HandleClientEvent_EventSource2;             // 0x140(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UObject*                               K2Node_HandleClientEvent_EventFocus2;              // 0x148(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FFortClientEvent                      K2Node_HandleClientEvent_ClientEvent2;             // 0x150(0x20)(NoDestructor)
	...
	struct FFortClientEvent                      K2Node_HandleClientEvent_ClientEvent;              // 0x180(0x20)(NoDestructor)
	struct FFortClientAnnouncementData_Tutorial  K2Node_CustomEvent_TutorialData;                   // 0x1A0(0x128)()
	bool                                         K2Node_CustomEvent_bShow;                          // 0x2C8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class UFortTutorialContext*                  CallFunc_GetContext_ReturnValue;                   // 0x2E0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UFortFrontEndContext*                  CallFunc_GetContext_ReturnValue2;                  // 0x2E8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
