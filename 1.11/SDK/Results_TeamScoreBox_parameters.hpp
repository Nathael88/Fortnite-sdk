...
public:
	...
	struct FFortScoreStylingInfo                 CallFunc_GetScoreStylingData_ScoreStylingInfo;     // 0x30(0x2F8)()
	bool                                         CallFunc_GetScoreStylingData_ReturnValue;          // 0x328(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_2500[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FSlateColor                           K2Node_MakeStruct_SlateColor;                      // 0x330(0x28)()
	...
	bool                                         K2Node_SwitchEnum_CmpSuccess;                      // 0x360(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
{
public:
	class UCommonNumericTextBlock*               NumericTextBlock;                                  // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	bool                                         K2Node_ComponentBoundEvent_HadCompleted;           // 0x28(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
