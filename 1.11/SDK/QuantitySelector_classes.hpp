...
{
public:
	uint8                                        Pad_3394[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FSliderStyle                          SliderStyle_MouseKeyboard;                         // 0x478(0x1F0)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FSliderStyle                          SliderStyle_XboxOne;                               // 0x668(0x1F0)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FSliderStyle                          SliderStyle_PS4;                                   // 0x858(0x1F0)(Edit, BlueprintVisible, DisableEditOnInstance)
	bool                                         bShowConfirmButton;                                // 0xA48(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn)
	bool                                         bShowCancelButton;                                 // 0xA49(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn)
	bool                                         bAllowZeroQuantity;                                // 0xA4A(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn)
