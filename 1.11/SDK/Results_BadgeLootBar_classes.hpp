...
public:
	...
	uint8                                        Pad_2812[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class UAudioComponent*                       YellowBarFillSound_AC;                             // 0x2B8(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
