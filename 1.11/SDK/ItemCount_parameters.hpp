...
public:
	...
	struct FMargin                               K2Node_MakeStruct_Margin2;                         // 0x18(0x10)(NoDestructor)
	struct FMargin                               K2Node_Select_Default;                             // 0x28(0x10)(NoDestructor)
	class UHorizontalBoxSlot*                    K2Node_DynamicCast_AsHorizontal_Box_Slot;          // 0x38(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                         Temp_bool_Variable2;                               // 0x42(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	enum class ESlateVisibility                  K2Node_Select2_Default;                            // 0x43(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
