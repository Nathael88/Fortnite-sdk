...
public:
	...
	uint8                                        Pad_3478[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FSlateBrush                           CallFunc_GetTileImage_ReturnValue;                 // 0xB8(0x78)()
	class FText                                  CallFunc_GetName_ReturnValue;                      // 0x130(0x18)()
	int32                                        CallFunc_GetBonusQuantity_ReturnValue2;            // 0x148(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_347A[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FText                                  CallFunc_Conv_IntToText_ReturnValue;               // 0x150(0x18)()
	int32                                        CallFunc_GetBaseQuantity_ReturnValue;              // 0x168(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_347B[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FText                                  CallFunc_GetNormalPrice_ReturnValue;               // 0x170(0x18)()
	class FText                                  CallFunc_Conv_IntToText_ReturnValue2;              // 0x188(0x18)()
	class FText                                  CallFunc_GetNormalPrice_ReturnValue2;              // 0x1A0(0x18)()
...
public:
	...
	enum class EFortMtxStoreOfferType            CallFunc_GetStoreOfferType_ReturnValue2;           // 0x22(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
