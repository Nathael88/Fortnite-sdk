...
public:
	...
	TArray<class UFortGameplayModifierItemDefinition*> DebugMods;                                         // 0x228(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
