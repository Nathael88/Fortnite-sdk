...
public:
	...
	bool                                         CallFunc_IsReadyForNextXpReward_Ready2;            // 0x2(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
public:
	...
	TArray<struct FFormatArgumentData>           K2Node_MakeArray_Array2;                           // 0xE8(0x10)(ZeroConstructor, ReferenceParm)
	class FText                                  CallFunc_Format_ReturnValue;                       // 0xF8(0x18)()
	class FText                                  CallFunc_Format_ReturnValue2;                      // 0x110(0x18)()
