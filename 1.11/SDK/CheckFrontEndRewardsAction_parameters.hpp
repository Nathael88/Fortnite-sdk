...
{
public:
	class UFrontEndRewards_Widget_C*             LocalRewardsWidget;                                // 0x0(0x8)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	struct FFortItemInstanceQuantityPair         CallFunc_Array_Get_Item2;                          // 0x78(0x10)(NoDestructor)
	...
	bool                                         CallFunc_Less_IntInt_ReturnValue2;                 // 0x99(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_IsVisibleToUser_ReturnValue;              // 0x9A(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_3568[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	struct FFortScriptedActionParams             K2Node_Event_Params;                               // 0x8(0x30)(NoDestructor)
