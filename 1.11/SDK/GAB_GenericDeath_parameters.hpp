...
public:
	...
	struct FHitResult                            CallFunc_EffectContextGetHitResult_ReturnValue;    // 0xC0(0x80)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
...
public:
	...
	class AFortPawn*                             CallFunc_GetActivatingPawn_ReturnValue2;           // 0x28(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_3D8A[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FGameplayEventData                    K2Node_Event_EventData;                            // 0x1F0(0xA8)()
