...
public:
	...
	struct FVector2D                             Temp_struct_Variable2;                             // 0x1C(0x8)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FLinearColor                          Temp_struct_Variable4;                             // 0x38(0x10)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         Temp_bool_Variable5;                               // 0x48(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                         Temp_bool_Variable6;                               // 0x6C(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	struct FVector2D                             K2Node_Select2_Default;                            // 0x70(0x8)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FText                                  K2Node_Select4_Default;                            // 0x110(0x18)()
	struct FLinearColor                          Temp_struct_Variable7;                             // 0x128(0x10)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FLinearColor                          Temp_struct_Variable8;                             // 0x138(0x10)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         Temp_bool_Variable7;                               // 0x148(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	enum class ESlateVisibility                  Temp_byte_Variable3;                               // 0x149(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                        K2Node_Select6_Default;                            // 0x160(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FLinearColor                          K2Node_Select7_Default;                            // 0x164(0x10)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         Temp_bool_Variable8;                               // 0x174(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	enum class ESlateVisibility                  K2Node_Select8_Default;                            // 0x175(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
