...
{
public:
	bool                                         DirectlySetQuantity;                               // 0x0(0x1)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
...
public:
	...
	bool                                         K2Node_Event_IsBeingReset;                         // 0x4(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
