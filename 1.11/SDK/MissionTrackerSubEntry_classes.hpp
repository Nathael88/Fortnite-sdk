...
public:
	...
	struct FSlateBrush                           DefaultBulletBrush;                                // 0x2C8(0x78)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FSlateBrush                           DefaultNonHUDBulletBrush;                          // 0x340(0x78)(Edit, BlueprintVisible, DisableEditOnInstance)
