...
{
public:
	uint8                                        Pad_3FB3[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class UParticleSystemComponent*              JumpParticleEffect;                                // 0xE90(0x8)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	class USceneComponent*                       Scene1;                                            // 0xEA0(0x8)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	class UMaterialInstanceDynamic*              JumpMaterial;                                      // 0xED0(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
