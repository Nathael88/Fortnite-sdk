...
public:
	...
	uint8                                        Pad_3D1D[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	enum class ESlateVisibility                  K2Node_Select2_Default;                            // 0x63(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_3D1E[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FText                                  Temp_text_Variable4;                               // 0x68(0x18)()
	class FText                                  K2Node_Select3_Default;                            // 0x80(0x18)()
	...
	class FText                                  K2Node_Select4_Default;                            // 0xD0(0x18)()
};
