...
public:
	...
	enum class ESlateVisibility                  K2Node_Select2_Default;                            // 0x70(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	uint8                                        Pad_3E2D[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	struct FSlateBrush                           K2Node_MakeStruct_SlateBrush;                      // 0x18(0x78)()
	bool                                         CallFunc_IsPerkHighlighted_ReturnValue;            // 0x90(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         Temp_bool_Variable2;                               // 0x91(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	struct FSlateBrush                           CallFunc_GetIcon_Brush;                            // 0x98(0x78)()
	bool                                         CallFunc_GetIcon_ReturnValue;                      // 0x110(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_3E3A[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FSlateBrush                           K2Node_Select2_Default;                            // 0x118(0x78)()
	struct FSlateBrush                           CallFunc_ResizeBrush_NewParam;                     // 0x190(0x78)()
};
...
public:
	struct FLinearColor                          CallFunc_GetHighlightColor_Color;                  // 0x0(0x10)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FSlateBrush                           CallFunc_NoResourceBrush_ReturnValue;              // 0x10(0x78)()
	...
	struct FSlateBrush                           CallFunc_GetIcon_Brush;                            // 0x90(0x78)()
	bool                                         CallFunc_GetIcon_ReturnValue;                      // 0x108(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_3E3C[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FSlateBrush                           K2Node_Select_Default;                             // 0x110(0x78)()
	struct FSlateBrush                           CallFunc_ResizeBrush_NewParam;                     // 0x188(0x78)()
};
...
public:
	...
	bool                                         CallFunc_ShouldFadePerk_Result;                    // 0x80(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_3E3E[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FLinearColor                          K2Node_MakeStruct_LinearColor;                     // 0x84(0x10)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
