...
public:
	...
	uint8                                        Pad_1DE4[0x78];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1DE7[0x58];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1DEF[0x2];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	struct FMovieSceneTrackCompilationParams     TemplateParameters;                                // 0x2D0(0x2)(NoDestructor, NativeAccessSpecifierPublic)
	uint8                                        Pad_1DF1[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TMap<class UObject*, struct FCachedMovieSceneEvaluationTemplate> InstancedSubSequenceEvaluationTemplates;           // 0x2D8(0x50)(ZeroConstructor, NativeAccessSpecifierPublic)
	enum class EMovieSceneCompletionMode         DefaultCompletionMode;                             // 0x328(0x1)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         bParentContextsAreSignificant;                     // 0x329(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_1DF2[0x6];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1DF3[0x348];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1DF5[0xB];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1DF6[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	struct FMovieSceneSequencePlaybackSettings   PlaybackSettings;                                  // 0x3F8(0x28)(NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                        Pad_1DF7[0x3D0];                                   // Fixing Size Of Struct [ Dumper-7 ]
