...
public:
	...
	uint8                                        Pad_39F5[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	enum class ESlateVisibility                  Temp_byte_Variable;                                // 0x1(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class ESlateVisibility                  Temp_byte_Variable2;                               // 0x2(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_39F8[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	struct FSlateBrush                           Brush;                                             // 0x18(0x78)(BlueprintVisible, BlueprintReadOnly, Parm)
	bool                                         Option_Enabled;                                    // 0x90(0x1)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_39FC[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	int32                                        RadialItemIndex;                                   // 0x94(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FString                                CallFunc_BuildString_Int_ReturnValue;              // 0xA0(0x10)(ZeroConstructor, HasGetValueTypeHash)
