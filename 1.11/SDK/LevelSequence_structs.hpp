...
{
public:
	uint8                                        Pad_1FE8[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1FE9[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1FEA[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	struct FMovieSceneSequenceID                 ShotID;                                            // 0x50(0x4)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
