...
{
public:
	uint8                                        Pad_1B5A[0x368];                                   // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1B5B[0x1C8];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1B5C[0x2E];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1B5E[0x17];                                    // Fixing Size After Last Property  [ Dumper-7 ]
