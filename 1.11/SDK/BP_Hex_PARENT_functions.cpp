...
// Parameters:
// enum class EFortMissionAlertCategoryCallFunc_GetMissionAlertCategory_ReturnValue                     (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// enum class EFortMissionAlertCategoryCallFunc_GetMissionAlertCategory_ReturnValue2                    (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void ABP_Hex_PARENT_C::HandleMissionAlert(enum class EFortMissionAlertCategory CallFunc_GetMissionAlertCategory_ReturnValue, class UUserWidget* CallFunc_GetUserWidgetObject_ReturnValue, class UMissionAlertIndicator_C* K2Node_DynamicCast_AsMission_Alert_Indicator, bool K2Node_DynamicCast_bSuccess, enum class EFortMissionAlertCategory CallFunc_GetMissionAlertCategory_ReturnValue2, bool CallFunc_EqualEqual_ByteByte_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue2, bool CallFunc_BooleanOR_ReturnValue, bool CallFunc_IsTileHidden_ReturnValue, bool CallFunc_IsMissionAlertTile_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, bool CallFunc_BooleanAND_ReturnValue)
{
	...
	Parms.CallFunc_GetMissionAlertCategory_ReturnValue2 = CallFunc_GetMissionAlertCategory_ReturnValue2;
