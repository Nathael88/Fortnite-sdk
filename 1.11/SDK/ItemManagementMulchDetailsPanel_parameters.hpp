...
public:
	...
	TArray<class UFortItem*>                     CallFunc_GetItemsToMulch_ReturnValue;              // 0x18(0x10)(ZeroConstructor, ReferenceParm)
	...
	TArray<class UFortItem*>                     CallFunc_GetItemsToMulch_ReturnValue2;             // 0x38(0x10)(ZeroConstructor, ReferenceParm)
	...
	class UFortCharacter*                        K2Node_DynamicCast_AsFort_Character;               // 0x68(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<enum class EItemRecyclingWarning>     CallFunc_EnumerateRecyclingWarningsForItems_OutWarnings; // 0x78(0x10)(ZeroConstructor, ReferenceParm)
	...
	class UWidget*                               K2Node_Select_Default;                             // 0x98(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<class UFortItem*>                     CallFunc_GetItemsToMulch_ReturnValue3;             // 0xA8(0x10)(ZeroConstructor, ReferenceParm)
	class UItemManagementMulchConfirmationDialogContent_C* CallFunc_Create_ReturnValue;                       // 0xB8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_AreAnyItemsAnimate_ReturnValue;           // 0xC0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	enum class EFortDialogResult                 Temp_byte_Variable;                                // 0xC1(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	enum class EFortDialogResult                 K2Node_CustomEvent_Result;                         // 0xD1(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_3376[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FName                                  K2Node_CustomEvent_ResultName;                     // 0xD8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	UDelegateProperty_                           K2Node_CreateDelegate_OutputDelegate;              // 0xE0(0x10)(ZeroConstructor, NoDestructor)
	class FText                                  CallFunc_GetWarningText_WarningText;               // 0xF0(0x18)()
	...
	class FText                                  Temp_text_Variable2;                               // 0x138(0x18)()
	...
	TArray<int32>                                CallFunc_GetItemCountsToMulch_ReturnValue;         // 0x158(0x10)(ZeroConstructor, ReferenceParm)
	...
	bool                                         CallFunc_IsSpaceAvailableForMulch_ReturnValue;     // 0x189(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_BooleanAND_ReturnValue2;                  // 0x18A(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
