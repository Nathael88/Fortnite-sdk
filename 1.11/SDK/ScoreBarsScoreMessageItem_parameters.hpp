...
public:
	...
	class UScoreMessageNumber_C*                 In_Score_Widget;                                   // 0x20(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
