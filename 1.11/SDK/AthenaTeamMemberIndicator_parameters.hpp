...
{
public:
	TArray<bool>                                 Team_Talking;                                      // 0x0(0x10)(BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm)
...
{
public:
	TArray<bool>                                 Team_Reviving;                                     // 0x0(0x10)(BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm)
...
{
public:
	TArray<bool>                                 DBNOStates;                                        // 0x0(0x10)(BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm)
	bool                                         CallFunc_Array_Get_Item;                           // 0x10(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
public:
	...
	class AFortPlayerPawn*                       CallFunc_GetCurrentPawn_ReturnValue;               // 0xA8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                         CallFunc_IsDBNO_ReturnValue;                       // 0xC9(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
