...
{
	static auto Func = Class->GetFunction("VaultCamera_Blueprint_C", "InpActEvt_RightMouseButton_K2Node_InputKeyEvent_3");

	Params::AVaultCamera_Blueprint_C_InpActEvt_RightMouseButton_K2Node_InputKeyEvent_3_Params Parms;
	Parms.Key = Key;
...
{
	static auto Func = Class->GetFunction("VaultCamera_Blueprint_C", "InpActEvt_RightMouseButton_K2Node_InputKeyEvent_2");

	Params::AVaultCamera_Blueprint_C_InpActEvt_RightMouseButton_K2Node_InputKeyEvent_2_Params Parms;
	Parms.Key = Key;
...
{
	static auto Func = Class->GetFunction("VaultCamera_Blueprint_C", "InpActEvt_LeftMouseButton_K2Node_InputKeyEvent_1");

	Params::AVaultCamera_Blueprint_C_InpActEvt_LeftMouseButton_K2Node_InputKeyEvent_1_Params Parms;
	Parms.Key = Key;
...
{
	static auto Func = Class->GetFunction("VaultCamera_Blueprint_C", "InpActEvt_LeftMouseButton_K2Node_InputKeyEvent_0");

	Params::AVaultCamera_Blueprint_C_InpActEvt_LeftMouseButton_K2Node_InputKeyEvent_0_Params Parms;
	Parms.Key = Key;
...
void AVaultCamera_Blueprint_C::ExecuteUbergraph_VaultCamera_Blueprint(int32 EntryPoint, const struct FKey& Temp_struct_Variable, const struct FKey& K2Node_InputKeyEvent_Key, const struct FKey& Temp_struct_Variable2, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue, class AFortPlayerPawn* CallFunc_GetHeroPlayerPawnByIndex_ReturnValue, const struct FKey& K2Node_InputKeyEvent_Key3, bool CallFunc_IsValid_ReturnValue, float K2Node_Event_DeltaSeconds, class APlayerController* CallFunc_GetPlayerController_ReturnValue, float CallFunc_GetInputMouseDelta_DeltaX, float CallFunc_GetInputMouseDelta_DeltaY, float CallFunc_Multiply_FloatFloat_ReturnValue, class APlayerController* CallFunc_GetPlayerController_ReturnValue2, const struct FKey& K2Node_InputKeyEvent_Key4, const struct FKey& K2Node_InputKeyEvent_Key2, bool CallFunc_IsValid_ReturnValue2, const struct FRotator& CallFunc_K2_GetActorRotation_ReturnValue, class APlayerController* CallFunc_GetPlayerController_ReturnValue3, float CallFunc_BreakRotator_Roll, float CallFunc_BreakRotator_Pitch, float CallFunc_BreakRotator_Yaw, float CallFunc_Subtract_FloatFloat_ReturnValue, TArray<class ATVPostProcessBP_C*>& CallFunc_GetAllActorsOfClass_OutActors, const struct FRotator& CallFunc_MakeRotator_ReturnValue, class ATVPostProcessBP_C* CallFunc_Array_Get_Item, const struct FHitResult& CallFunc_K2_SetRelativeRotation_SweepHitResult, bool CallFunc_K2_SetActorRotation_ReturnValue, class AFortTimeOfDayManager* CallFunc_GetTimeOfDayManagerFromContext_ReturnValue)
{
