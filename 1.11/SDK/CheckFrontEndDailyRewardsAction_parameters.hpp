...
public:
	...
	struct FFortScriptedActionParams             K2Node_Event_Params;                               // 0x18(0x30)(NoDestructor)
	...
	struct FFortClientEvent                      K2Node_HandleClientEvent_ClientEvent;              // 0x58(0x20)(NoDestructor)
	...
	uint8                                        Pad_3572[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	bool                                         CallFunc_Not_PreBool_ReturnValue2;                 // 0xAF(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
