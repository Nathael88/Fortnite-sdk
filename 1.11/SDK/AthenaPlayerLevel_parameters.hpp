...
public:
	...
	bool                                         CallFunc_GreaterEqual_IntInt_ReturnValue;          // 0x99(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_31B3[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FAthenaSeasonRewardLevelInfo          CallFunc_GetSeasonLevelInfo_ReturnValue;           // 0xA0(0x20)()
