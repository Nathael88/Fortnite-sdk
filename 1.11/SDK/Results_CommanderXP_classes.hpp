...
public:
	...
	class UCommonTextBlock*                      TextSkillPointIncrement_0;                         // 0x300(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
