...
public:
	...
	struct FAthenaMatchStats                     MatchStats;                                        // 0x258(0x74)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
	...
	void OnTeamStatsAvailable(const struct FFormatArgumentData& K2Node_MakeStruct_FormatArgumentData, const struct FFormatArgumentData& K2Node_MakeStruct_FormatArgumentData2, TArray<struct FFormatArgumentData>& K2Node_MakeArray_Array, class FText CallFunc_Format_ReturnValue);
