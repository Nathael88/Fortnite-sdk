...
public:
	...
	bool                                         Temp_bool_Has_Been_Initd_Variable2;                // 0x7(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	struct FHitResult                            K2Node_Event_Hit;                                  // 0x10(0x80)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	class UPrimitiveComponent*                   CallFunc_BreakHitResult_HitComponent;              // 0xE0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                         Temp_bool_IsClosed_Variable2;                      // 0x130(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_2EDD[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<class AActor*>                        K2Node_Event_HitActors;                            // 0x138(0x10)(ZeroConstructor, ReferenceParm)
	TArray<struct FHitResult>                    K2Node_Event_HitResults;                           // 0x148(0x10)(ZeroConstructor, ReferenceParm, ContainsInstancedReference)
	...
	class UParticleSystemComponent*              CallFunc_SpawnEmitterAtLocation_ReturnValue;       // 0x168(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
