...
public:
	...
	struct FSlateBrush                           HighlightedCheckmarkBrush;                         // 0x350(0x78)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FSlateBrush                           NormalCheckmarkBrush;                              // 0x3C8(0x78)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FSlateBrush                           NonMatchBrush;                                     // 0x440(0x78)(Edit, BlueprintVisible, DisableEditOnInstance)
