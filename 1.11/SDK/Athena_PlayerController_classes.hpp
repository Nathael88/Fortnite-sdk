...
public:
	...
	class USceneComponent*                       ListenerOverride;                                  // 0x3418(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
