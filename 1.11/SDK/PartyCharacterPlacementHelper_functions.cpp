...
void APartyCharacterPlacementHelper_C::Refresh_Lights(const struct FFortTeamMemberInfo& Team_Info, bool Temp_bool_Variable, const struct FLinearColor& Temp_struct_Variable, const struct FLinearColor& Temp_struct_Variable2, class UFortMcpContext* CallFunc_GetContext_ReturnValue, const struct FFortBattlePassInfo& CallFunc_GetBattlePassInfoForPlayer_Result, bool CallFunc_BooleanAND_ReturnValue, const struct FLinearColor& K2Node_Select_Default)
{
...
// class ULobbyPlayerPadBottom_C*     K2Node_DynamicCast_AsLobby_Player_Pad_Bottom                     (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               K2Node_DynamicCast_bSuccess                                      (ZeroConstructor, IsPlainOldData, NoDestructor)
...
// class UUserWidget*                 CallFunc_GetUserWidgetObject_ReturnValue4                        (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void APartyCharacterPlacementHelper_C::InitializeWidgets(class UUserWidget* CallFunc_GetUserWidgetObject_ReturnValue, class ULobbyPlayerPadBottom_C* K2Node_DynamicCast_AsLobby_Player_Pad_Bottom, bool K2Node_DynamicCast_bSuccess, class UUserWidget* CallFunc_GetUserWidgetObject_ReturnValue2, class UUserWidget* CallFunc_GetUserWidgetObject_ReturnValue3, class ULobbyPlayerAddPlayer_C* K2Node_DynamicCast_AsLobby_Player_Add_Player, bool K2Node_DynamicCast_bSuccess2, class ULobbyPlayerPadGadgets_C* K2Node_DynamicCast_AsLobby_Player_Pad_Gadgets, bool K2Node_DynamicCast_bSuccess3, class UUserWidget* CallFunc_GetUserWidgetObject_ReturnValue4, class ULobbyPlayerPadTop_C* K2Node_DynamicCast_AsLobby_Player_Pad_Top, bool K2Node_DynamicCast_bSuccess4)
{
	...
	Parms.CallFunc_GetUserWidgetObject_ReturnValue4 = CallFunc_GetUserWidgetObject_ReturnValue4;
...
// struct FFortClientEvent            K2Node_HandleClientEvent_ClientEvent2                            (NoDestructor)
...
// struct FFortClientEvent            K2Node_HandleClientEvent_ClientEvent                             (NoDestructor)
