...
public:
	...
	class UFortItemManagementScreen*             HostItemManagementScreen;                          // 0x258(0x8)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
