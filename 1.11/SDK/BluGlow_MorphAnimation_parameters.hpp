...
public:
	...
	struct FHitResult                            CallFunc_K2_AddLocalRotation_SweepHitResult;       // 0x50(0x80)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	int32                                        CallFunc_Percent_IntInt_ReturnValue;               // 0xD0(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
