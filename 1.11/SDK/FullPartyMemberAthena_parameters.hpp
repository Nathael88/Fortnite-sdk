...
{
public:
	TArray<int32>                                Kills;                                             // 0x0(0x10)(BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm)
...
{
public:
	TArray<bool>                                 Talking;                                           // 0x0(0x10)(BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm)
...
{
public:
	TArray<bool>                                 Mutes;                                             // 0x0(0x10)(BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm)
	bool                                         CallFunc_Array_IsValidIndex_ReturnValue;           // 0x10(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_Array_Get_Item;                           // 0x11(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
public:
	...
	uint8                                        Pad_3894[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	TArray<int32>                                CallFunc_GetSquadKills_Kills;                      // 0x80(0x10)(ZeroConstructor, ReferenceParm)
	TArray<bool>                                 CallFunc_GetSquadMuted_MutedStates;                // 0x90(0x10)(ZeroConstructor, ReferenceParm)
	TArray<bool>                                 CallFunc_GetSquadTalking_TalkingStates;            // 0xA0(0x10)(ZeroConstructor, ReferenceParm)
	...
	struct FUniqueNetIdRepl                      CallFunc_GetPlatformUniqueNetId_ReturnValue;       // 0xE0(0x28)(HasGetValueTypeHash)
	class AActor*                                CallFunc_GetOwner_ReturnValue;                     // 0x108(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_NotEqual_ObjectObject_ReturnValue;        // 0x110(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_Array_IsValidIndex_ReturnValue;           // 0x111(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_389B[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FFortTeamMemberInfo                   K2Node_Event_NewInfo;                              // 0x118(0x1A8)()
	class FString                                CallFunc_GetPlatformName_ReturnValue;              // 0x2C0(0x10)(ZeroConstructor, HasGetValueTypeHash)
	UDelegateProperty_                           K2Node_CreateDelegate_OutputDelegate6;             // 0x2D0(0x10)(ZeroConstructor, NoDestructor)
	bool                                         CallFunc_StartsWith_ReturnValue;                   // 0x2E0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
