...
public:
	...
	enum class ESlateVisibility                  Temp_byte_Variable4;                               // 0x2B(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class EFortSupportBonusType             Temp_byte_Variable5;                               // 0x2C(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FSlateBrush                           K2Node_MakeStruct_SlateBrush;                      // 0xD8(0x78)()
};
...
public:
	...
	bool                                         CallFunc_IsPerkEmpty_ReturnValue;                  // 0x110(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_317F[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FSlateBrush                           CallFunc_GetIcon_Brush;                            // 0x118(0x78)()
	bool                                         CallFunc_GetIcon_ReturnValue;                      // 0x190(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_3180[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FSlateBrush                           K2Node_SetFieldsInStruct_StructOut;                // 0x198(0x78)()
	class FText                                  CallFunc_GetTooltipTitle_ReturnValue2;             // 0x210(0x18)()
};
