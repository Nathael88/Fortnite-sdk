...
public:
	...
	class UResults_TeamTotalScore_C*             TeamTotalScore;                                    // 0x280(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
