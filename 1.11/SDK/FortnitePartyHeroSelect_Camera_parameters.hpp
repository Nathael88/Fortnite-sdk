...
public:
	...
	struct FKey                                  K2Node_InputKeyEvent_Key2;                         // 0x20(0x18)(HasGetValueTypeHash)
	...
	class APlayerController*                     CallFunc_GetPlayerController_ReturnValue2;         // 0x90(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FKey                                  Temp_struct_Variable2;                             // 0xD0(0x18)(HasGetValueTypeHash)
	...
	struct FHitResult                            CallFunc_K2_SetRelativeRotation_SweepHitResult;    // 0x108(0x80)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	class AFortTimeOfDayManager*                 CallFunc_GetTimeOfDayManagerFromContext_ReturnValue; // 0x188(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class APlayerController*                     CallFunc_GetPlayerController_ReturnValue3;         // 0x190(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
