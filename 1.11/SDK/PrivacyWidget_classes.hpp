...
public:
	...
	class FText                                  PublicHint;                                        // 0x518(0x18)(Edit, BlueprintVisible, DisableEditOnInstance)
	class FText                                  FriendsOnlyHint;                                   // 0x530(0x18)(Edit, BlueprintVisible, DisableEditOnInstance)
	class FText                                  PrivateHint;                                       // 0x548(0x18)(Edit, BlueprintVisible, DisableEditOnInstance)
	class FText                                  FriendsOfFriendsHint;                              // 0x560(0x18)(Edit, BlueprintVisible, DisableEditOnInstance)
	class FText                                  FriendsOfFriendsPrivateHint;                       // 0x578(0x18)(Edit, BlueprintVisible, DisableEditOnInstance)
	class FText                                  TencentFriendsHint;                                // 0x590(0x18)(Edit, BlueprintVisible, DisableEditOnInstance)
	class FText                                  TencentPrivateHint;                                // 0x5A8(0x18)(Edit, BlueprintVisible, DisableEditOnInstance)
	...
	void ExecuteUbergraph_PrivacyWidget(int32 EntryPoint, bool Temp_bool_Variable, bool Temp_bool_Variable2, class UCommonButton* K2Node_ComponentBoundEvent_Button10, class UCommonButton* K2Node_ComponentBoundEvent_Button9, class UCommonButton* K2Node_ComponentBoundEvent_Button8, class UCommonButton* K2Node_ComponentBoundEvent_Button7, class UCommonButton* K2Node_ComponentBoundEvent_Button6, class UCommonButton* K2Node_ComponentBoundEvent_Button5, class UCommonButton* K2Node_ComponentBoundEvent_Button4, class UCommonButton* K2Node_ComponentBoundEvent_Button3, bool CallFunc_GetSelected_ReturnValue, class UCommonButton* K2Node_ComponentBoundEvent_Button2, class UCommonButton* K2Node_ComponentBoundEvent_Button, class FText K2Node_Select_Default, bool Temp_bool_Variable3, class UFortUINavigationManager* CallFunc_GetUINavigationManager_ReturnValue, class UFortUIManagerWidget_NUI* CallFunc_GetUIManagerWidget_ReturnValue, bool CallFunc_IsTencentBuild_ReturnValue, bool CallFunc_IsTencentBuild_ReturnValue2, class FText K2Node_Select2_Default, class FText K2Node_Select3_Default);
};
