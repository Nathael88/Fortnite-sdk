...
{
public:
	uint8                                        Pad_24C6[0x68];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_24C7[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_24C8[0xA8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_24C9[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_24CF[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
