...
{
public:
	class UParticleSystemComponent*              ParticleSystem;                                    // 0x368(0x8)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
