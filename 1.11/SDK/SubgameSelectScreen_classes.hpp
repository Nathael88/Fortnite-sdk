...
public:
	...
	class UProgressModalWidget_C*                LeavingMatchmakingDialog;                          // 0x4B0(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	void InitializeShortDescriptions(class FText ShortDescription, bool Temp_bool_Variable, int32 Temp_int_Variable, int32 Temp_int_Variable2, bool CallFunc_GetIsOnSale_ReturnValue, bool CallFunc_GetIsOnSale_ReturnValue2, int32 K2Node_Select_Default, class FText CallFunc_GetEmptyText_ReturnValue, class FText CallFunc_GetEmptyText_ReturnValue2, int32 Temp_int_Variable3, int32 Temp_int_Variable4, class FText CallFunc_GetShortDescription_ShortDescription, bool CallFunc_GetShortDescription_ReturnValue, bool Temp_bool_Variable2, class FText CallFunc_GetShortDescription_ShortDescription2, bool CallFunc_GetShortDescription_ReturnValue2, int32 K2Node_Select2_Default);
