...
public:
	...
	struct FAnimNode_Root                        AnimGraphNode_Root_ADD84ECA4C179A894077EA926E4E8C27; // 0x478(0x48)()
	struct FAnimNode_CopyPoseFromMesh            AnimGraphNode_CopyPoseFromMesh_D97E649D45B817241D9AEC8AFF8B1030; // 0x4C0(0x98)(ContainsInstancedReference)
	struct FAnimNode_Slot                        AnimGraphNode_Slot_14C43EE54D79827F00DF1E9A8242ED73; // 0x558(0x68)()
	struct FAnimNode_LayeredBoneBlend            AnimGraphNode_LayeredBoneBlend_26AEFC2749B6D18C132B8A9AFACB7107; // 0x5C0(0xE0)()
	struct FAnimNode_LayeredBoneBlend            AnimGraphNode_LayeredBoneBlend_B3EB7DD7487D3DA8C89669A6B3EE960E; // 0x6A0(0xE0)()
	struct FAnimNode_BlendListByBool             AnimGraphNode_BlendListByBool_CF536D774F38E2EEF45328867E530E1F; // 0x780(0xD0)()
	struct FAnimNode_CopyPoseFromMesh            AnimGraphNode_CopyPoseFromMesh_3C3D052A4A90851006AF169ADEDB9A0D; // 0x850(0x98)(ContainsInstancedReference)
	struct FAnimNode_ConvertLocalToComponentSpace AnimGraphNode_LocalToComponentSpace_9E42BD2C4D12D2F1E124EFBCD05D9810; // 0x8E8(0x48)()
	struct FAnimNode_ConvertComponentToLocalSpace AnimGraphNode_ComponentToLocalSpace_1E99F95C4ECF47136D41C482F786FD2C; // 0x930(0x48)()
