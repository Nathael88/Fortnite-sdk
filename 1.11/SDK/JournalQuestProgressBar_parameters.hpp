...
public:
	...
	struct FProgressBarStyle                     K2Node_MakeStruct_ProgressBarStyle;                // 0x60(0x170)()
	...
	class UFortTooltipUIContext*                 CallFunc_GetContext_ReturnValue3;                  // 0x1D8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        CallFunc_GetTooltipNumericValue_Value;             // 0x1E0(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_GetTooltipNumericValue_ReturnValue;       // 0x1E4(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_3150[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FText                                  CallFunc_GetTooltipTextFromToken_OutText;          // 0x1E8(0x18)()
	bool                                         CallFunc_GetTooltipTextFromToken_ReturnValue;      // 0x200(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_GreaterEqual_FloatFloat_ReturnValue;      // 0x201(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
