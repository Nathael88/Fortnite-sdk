...
void UAthenaGamePhaseChangeWidget_C::PlayIntroAnimation(enum class EAthenaGamePhaseStep Step, bool CallFunc_EqualEqual_ByteByte_ReturnValue, bool Temp_bool_Variable, class UWidgetAnimation* K2Node_Select_Default)
{
...
void UAthenaGamePhaseChangeWidget_C::PlayGamePhaseAlertSound(enum class EAthenaGamePhaseStep Step, enum class EAthenaGamePhaseStep Temp_byte_Variable, class USoundBase* Temp_object_Variable, class USoundBase* Temp_object_Variable2, class USoundBase* Temp_object_Variable3, class USoundBase* Temp_object_Variable4, class USoundBase* Temp_object_Variable5, class USoundBase* Temp_object_Variable6, class USoundBase* Temp_object_Variable7, class USoundBase* Temp_object_Variable8, class USoundBase* Temp_object_Variable9, class USoundBase* Temp_object_Variable10, class USoundBase* K2Node_Select_Default, bool CallFunc_IsValid_ReturnValue)
{
...
// enum class EAthenaGamePhaseStep    K2Node_Event_Step2                                               (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class FText                        K2Node_Event_Message                                             ()
// class FText                        K2Node_Event_TimeText                                            ()
// class UWidgetAnimation*            K2Node_Event_Animation                                           (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
