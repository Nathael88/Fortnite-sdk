...
{
public:
	enum class ETextCommit                       TextCommitType;                                    // 0x0(0x1)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_3382[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UCommonBorder*                         HighlightBorder;                                   // 0x8(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UCommonBorder*                         NormalBorder;                                      // 0x10(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	class FText                                  K2Node_ComponentBoundEvent_Text4;                  // 0x8(0x18)()
	...
	class FText                                  K2Node_ComponentBoundEvent_Text3;                  // 0x28(0x18)()
	...
	class FText                                  K2Node_ComponentBoundEvent_Text2;                  // 0x50(0x18)()
	class FText                                  K2Node_ComponentBoundEvent_Text;                   // 0x68(0x18)()
