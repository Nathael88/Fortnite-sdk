...
public:
	...
	{
		static class UClass* Clss = UObject::FindClassFast("PresentXmas5_C");
		return Clss;
	}
	...
	void OnLootRepeat();
	void OnBeginSearch();
	void ExecuteUbergraph_PresentXmas5(int32 EntryPoint, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue);
};
