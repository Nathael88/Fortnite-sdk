...
{
public:
	uint8                                        Pad_1B9C[0xB8];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	float                                        ElapsedTime;                                       // 0x38(0x4)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_1B9D[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
