...
public:
	...
	struct FHitResult                            CallFunc_GetHitResult_ReturnValue;                 // 0xC8(0x80)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	struct FVector                               CallFunc_BreakHitResult_Location;                  // 0x154(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                               CallFunc_BreakHitResult_ImpactPoint;               // 0x160(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                               CallFunc_BreakHitResult_Normal;                    // 0x16C(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                               CallFunc_BreakHitResult_ImpactNormal;              // 0x178(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
