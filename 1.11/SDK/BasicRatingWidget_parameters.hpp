...
public:
	...
	struct FSlateBrush                           K2Node_MakeStruct_SlateBrush;                      // 0x48(0x78)()
	enum class ESlateVisibility                  K2Node_Select2_Default;                            // 0xC0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
