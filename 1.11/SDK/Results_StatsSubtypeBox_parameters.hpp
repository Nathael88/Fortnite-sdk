...
public:
	...
	struct FFortScoreStylingInfo                 CallFunc_GetScoreStylingData_ScoreStylingInfo;     // 0x40(0x2F8)()
	bool                                         CallFunc_GetScoreStylingData_ReturnValue;          // 0x338(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_365A[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FSlateColor                           K2Node_MakeStruct_SlateColor;                      // 0x340(0x28)()
