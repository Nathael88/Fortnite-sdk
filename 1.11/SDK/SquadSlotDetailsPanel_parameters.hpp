...
public:
	...
	class FName                                  CallFunc_GetIdOfSquadSlotToManageBP_OutSquadId2;   // 0x58(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                        CallFunc_GetIdOfSquadSlotToManageBP_OutSquadSlotIndex2; // 0x60(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FHomebaseSquadSlot                    CallFunc_Array_Get_Item;                           // 0x108(0x60)()
	bool                                         CallFunc_IsValid_ReturnValue3;                     // 0x168(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	enum class EFortItemType                     CallFunc_Array_Get_Item2;                          // 0x169(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FText                                  CallFunc_ToText_ReturnValue;                       // 0x170(0x18)()
	...
	bool                                         CallFunc_Array_IsValidIndex_ReturnValue;           // 0x18A(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_26BB[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<enum class EFortSquadSlottingRestrictionReason> CallFunc_GetSlottingRestrictionReasons_ReturnValue; // 0x190(0x10)(ZeroConstructor, ReferenceParm)
	...
	class FText                                  CallFunc_GetRestrictionReasonsAsText_Text;         // 0x1A8(0x18)()
	...
	class UHomeBaseContext*                      CallFunc_GetContext_ReturnValue3;                  // 0x1C8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FName                                  CallFunc_GetUnlockingHomebaseNodeIdForSquadSlot_ReturnValue; // 0x1D8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_NotEqual_NameName_ReturnValue;            // 0x1E0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         Temp_bool_Variable3;                               // 0x1E1(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                         Temp_bool_Variable4;                               // 0x228(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class UWidget*                               K2Node_Select3_Default;                            // 0x280(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UWidget*                               K2Node_Select4_Default;                            // 0x2A8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FFormatArgumentData                   K2Node_MakeStruct_FormatArgumentData3;             // 0x2B0(0x40)(HasGetValueTypeHash)
	class UWidget*                               K2Node_Select5_Default;                            // 0x2F0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TArray<struct FFormatArgumentData>           K2Node_MakeArray_Array2;                           // 0x2F8(0x10)(ZeroConstructor, ReferenceParm)
	class FText                                  CallFunc_Format_ReturnValue2;                      // 0x308(0x18)()
};
