...
public:
	...
	TArray<float>                                InverseMasses;                                     // 0x60(0x10)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FClothVertBoneData>            BoneData;                                          // 0x70(0x10)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	int32                                        MaxBoneWeights;                                    // 0x80(0x4)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                        NumFixedVerts;                                     // 0x84(0x4)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<uint32>                               SelfCollisionIndices;                              // 0x88(0x10)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FClothPhysicalMeshData                PhysicalMeshData;                                  // 0x0(0x98)(Edit, NativeAccessSpecifierPublic)
	struct FClothCollisionData                   CollisionData;                                     // 0x98(0x30)(Edit, NativeAccessSpecifierPublic)
	uint8                                        Pad_202C[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
