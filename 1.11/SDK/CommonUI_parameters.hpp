...
{
public:
	struct FSlateBrush                           InProgressMaterialBrush;                           // 0x0(0x78)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	class FName                                  InProgressMaterialParam;                           // 0x78(0x8)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FSlateBrush                           ReturnValue;                                       // 0x18(0x78)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
