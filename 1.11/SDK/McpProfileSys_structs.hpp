...
{
public:
	class FString                                ItemType;                                          // 0x0(0x10)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_18DC[0x68];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_18DE[0x70];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_18DF[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
