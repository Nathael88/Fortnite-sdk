...
void UMainMenu_C::InitializeMainMenu(bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable2, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue, bool CallFunc_IsInZone_ReturnValue, int32 Temp_int_Array_Index_Variable, enum class ESlateVisibility K2Node_Select_Default, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue2, enum class ESlateVisibility Temp_byte_Variable3, bool CallFunc_AllowLogout_ReturnValue, enum class ESlateVisibility Temp_byte_Variable4, bool Temp_bool_Variable2, enum class ESlateVisibility K2Node_Select2_Default, TArray<class UIconTextButton_C*>& K2Node_MakeArray_Array, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class UIconTextButton_C* CallFunc_Array_Get_Item, class UPrivacyWidget_C* CallFunc_Create_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue3, int32 Temp_int_Loop_Counter_Variable, bool CallFunc_IsMobileApp_ReturnValue, bool CallFunc_BooleanOR_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue2, enum class ESlateVisibility Temp_byte_Variable5, class UShowFriendCodesSelection_C* CallFunc_Create_ReturnValue2, bool CallFunc_IsOutpostOwner_OutpostOwner, enum class ESlateVisibility Temp_byte_Variable6, class UFortUIDataConfigurationContext* CallFunc_GetContext_ReturnValue4, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue5, bool CallFunc_ArePartyFeaturesEnabled_ReturnValue, bool CallFunc_AllowQuit_ReturnValue, bool CallFunc_IsInZone_ReturnValue2, bool CallFunc_Not_PreBool_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, enum class ESlateVisibility Temp_byte_Variable7, enum class ESlateVisibility Temp_byte_Variable8, bool Temp_bool_Variable3, bool Temp_bool_Variable4, enum class ESlateVisibility K2Node_Select3_Default, enum class ESlateVisibility K2Node_Select4_Default, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue3, class UMessageCenterWidget_C* CallFunc_Create_ReturnValue3, class UNews_C* CallFunc_Create_ReturnValue4, class UPermissionsRoot_C* CallFunc_Create_ReturnValue5, class ULegalInfo_C* CallFunc_Create_ReturnValue6, class UCredits_C* CallFunc_Create_ReturnValue7, class UOptionsMenu_C* CallFunc_Create_ReturnValue8)
{
