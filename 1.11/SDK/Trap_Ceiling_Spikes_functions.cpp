...
struct FTransform ATrap_Ceiling_Spikes_C::GetFireLocationAndRotation(const struct FTransform& CallFunc_K2_GetComponentToWorld_ReturnValue)
{
	static auto Func = Class->GetFunction("Trap_Ceiling_Spikes_C", "GetFireLocationAndRotation");

	Params::ATrap_Ceiling_Spikes_C_GetFireLocationAndRotation_Params Parms;
