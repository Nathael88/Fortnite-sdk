...
public:
	...
	struct FAnimNode_Root                        AnimGraphNode_Root_3D36AA2D48E736954157ABB046C8C983; // 0x478(0x48)()
	class USkeletalMeshComponent*                MeshToCopy;                                        // 0x4C0(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
