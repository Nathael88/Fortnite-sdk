...
void UAbilitiesPage_C::InitializeAbilityTiles(const TArray<class UFortGadgetItemDefinition*>& SlottedGadgets, const TArray<class UAbilitiesPageTile_C*>& AvailableSlots, int32 Temp_int_Array_Index_Variable, int32 CallFunc_Array_Length_ReturnValue, class UAbilitiesPageTile_C* CallFunc_Array_Get_Item, bool CallFunc_Greater_IntInt_ReturnValue, int32 CallFunc_Array_Add_ReturnValue, int32 CallFunc_Array_Add_ReturnValue2, int32 CallFunc_Array_Add_ReturnValue3, int32 CallFunc_Array_Add_ReturnValue4, int32 Temp_int_Loop_Counter_Variable, class UFortInventoryContext* CallFunc_GetContext_ReturnValue, class UFortItem* CallFunc_GetQuickBarSlottedItem_ReturnValue, class UFortItem* CallFunc_GetQuickBarSlottedItem_ReturnValue2, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsValid_ReturnValue2, class UFortItem* CallFunc_GetQuickBarSlottedItem_ReturnValue3, int32 CallFunc_Add_IntInt_ReturnValue, bool CallFunc_IsValid_ReturnValue3, int32 CallFunc_Array_Add_ReturnValue5, int32 CallFunc_Array_Add_ReturnValue6, bool CallFunc_Array_RemoveItem_ReturnValue, bool CallFunc_Array_RemoveItem_ReturnValue2, class UFortInventoryContext* CallFunc_GetContext_ReturnValue2, bool CallFunc_Array_RemoveItem_ReturnValue3, int32 CallFunc_Array_Add_ReturnValue7, class UFortHeroManagementContext* CallFunc_GetContext_ReturnValue3, const struct FHeroUIData& CallFunc_GetHeroData_HeroData, bool CallFunc_GetHeroData_ReturnValue, TArray<struct FFortUIPerk>& CallFunc_GetHeroAbilityPerks_HeroAbilityPerks, bool CallFunc_GetHeroAbilityPerks_ReturnValue, class UFortInventoryContext* CallFunc_GetContext_ReturnValue4, const struct FFortUIPerk& CallFunc_Array_Get_Item2, class UFortItem* CallFunc_GetQuickBarSlottedItem_ReturnValue4, bool CallFunc_IsValid_ReturnValue4, class UFortItem* CallFunc_GetQuickBarSlottedItem_ReturnValue5, class UFortAbilityKit* CallFunc_GetGrantedAbilityKit_ReturnValue, bool CallFunc_IsValid_ReturnValue5, TArray<class UFortGadgetItemDefinition*>& CallFunc_BP_GetGadgets_GadgetItemDefinitions, class UFortGadgetItemDefinition* CallFunc_Array_Get_Item3, bool CallFunc_Array_Contains_ReturnValue, int32 CallFunc_Array_Length_ReturnValue2, bool CallFunc_Less_IntInt_ReturnValue)
{
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UVerticalBox*                ButtonContainer                                                  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UCommonButton*               InSelectedButton                                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UCommonButton*               NewLocalVar_0                                                    (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UCommonButton*               AbilityButton                                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
