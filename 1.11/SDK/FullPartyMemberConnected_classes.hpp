...
public:
	...
	struct FFortTeamMemberInfo                   MemberInfo;                                        // 0x250(0x1A8)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FVector2D                             Dimensions;                                        // 0x3F8(0x8)(Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
