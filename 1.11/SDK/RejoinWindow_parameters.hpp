...
public:
	...
	class FText                                  LocalRetryFailure;                                 // 0x20(0x18)(Edit, BlueprintVisible)
	float                                        LocalTimeoutSeconds;                               // 0x38(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
