...
public:
	...
	uint8                                        Pad_3CC5[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	void HandleBack(bool* Passthrough, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue, class UFortUIManagerWidget_NUI* CallFunc_GetUIManagerWidget_ReturnValue, bool CallFunc_IsInZone_ReturnValue, class UFortHUDContext* CallFunc_GetContext_ReturnValue2);
	void Construct();
	void Destruct();
	void OnActivated();
