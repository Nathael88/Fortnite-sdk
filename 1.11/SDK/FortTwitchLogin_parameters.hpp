...
public:
	...
	TArray<struct FFortAnalyticsEventAttribute>  K2Node_MakeArray_Array;                            // 0x60(0x10)(ZeroConstructor, ReferenceParm)
};
...
public:
	...
	TArray<struct FFortAnalyticsEventAttribute>  K2Node_MakeArray_Array;                            // 0x40(0x10)(ZeroConstructor, ReferenceParm)
};
...
{
public:
	class UFortTwitchLoginModalWidget*           Modal;                                             // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	class FText                                  K2Node_Event_ErrorTitle;                           // 0x120(0x18)()
	class FText                                  K2Node_Event_ErrorMessage;                         // 0x138(0x18)()
