...
{
public:
	struct FChoiceDataEntry                      Choice;                                            // 0x0(0x50)(BlueprintVisible, BlueprintReadOnly, Parm)
	...
	class UPlayerChoiceWidget_C*                 Owner;                                             // 0x58(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
