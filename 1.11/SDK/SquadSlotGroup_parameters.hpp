...
public:
	...
	struct FSlateBrush                           K2Node_MakeStruct_SlateBrush;                      // 0x38(0x78)()
	...
	struct FPointerEvent                         K2Node_Event_MouseEvent2;                          // 0xF0(0x70)()
	struct FPointerEvent                         K2Node_Event_MouseEvent;                           // 0x160(0x70)()
};
