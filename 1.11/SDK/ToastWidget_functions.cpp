...
{
	static auto Func = Class->GetFunction("ToastWidget_C", "SetImage");

	Params::UToastWidget_C_SetImage_Params Parms;
...
// class UCommonTextBlock*            LocalTextBlock                                                   (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UToastWidget_C::SetToast(class UFortUINotification* Toast, enum class ESlateVisibility CallFunc_GetOpenButtonVisibility_ReturnValue)
{
