...
public:
	...
	enum class ESlateVisibility                  K2Node_Select2_Default;                            // 0x9(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	uint8                                        Pad_421B[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
