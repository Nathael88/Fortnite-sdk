...
public:
	...
	uint8                                        Pad_3360[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3361[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FHitResult                            CallFunc_K2_SetRelativeTransform_SweepHitResult;   // 0x190(0x80)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	struct FVector                               CallFunc_MakeVector_ReturnValue3;                  // 0x218(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                               CallFunc_VLerp_ReturnValue;                        // 0x224(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FTransform                            CallFunc_MakeTransform_ReturnValue3;               // 0x230(0x30)(IsPlainOldData, NoDestructor)
	struct FHitResult                            CallFunc_K2_SetActorRelativeTransform_SweepHitResult; // 0x260(0x80)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	struct FHitResult                            CallFunc_K2_SetActorRelativeTransform_SweepHitResult2; // 0x2E0(0x80)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	class AFortTimeOfDayManager*                 CallFunc_GetTimeOfDayManagerFromContext_ReturnValue; // 0x360(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FHitResult                            CallFunc_K2_SetActorTransform_SweepHitResult;      // 0x368(0x80)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	bool                                         CallFunc_K2_SetActorTransform_ReturnValue;         // 0x3E8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_3363[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<class ATVPostProcessBP_C*>            CallFunc_GetAllActorsOfClass_OutActors;            // 0x3F0(0x10)(ZeroConstructor, ReferenceParm)
	class ATVPostProcessBP_C*                    CallFunc_Array_Get_Item;                           // 0x400(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class APlayerController*                     CallFunc_GetPlayerController_ReturnValue;          // 0x408(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TArray<class AWM_Lights_C*>                  CallFunc_GetAllActorsOfClass_OutActors2;           // 0x410(0x10)(ZeroConstructor, ReferenceParm)
	class AWM_Lights_C*                          CallFunc_Array_Get_Item2;                          // 0x420(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TArray<class AWM_Lights_C*>                  CallFunc_GetAllActorsOfClass_OutActors3;           // 0x428(0x10)(ZeroConstructor, ReferenceParm)
	class AWM_Lights_C*                          CallFunc_Array_Get_Item3;                          // 0x438(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
