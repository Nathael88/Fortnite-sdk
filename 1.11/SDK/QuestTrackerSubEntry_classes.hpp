...
public:
	...
	struct FSlateBrush                           NonHUDBullet;                                      // 0x2A0(0x78)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FSlateBrush                           NonHUDPin;                                         // 0x318(0x78)(Edit, BlueprintVisible, DisableEditOnInstance)
