...
{
public:
	struct FChoiceDataEntry                      ChoiceData;                                        // 0x0(0x50)(BlueprintVisible, BlueprintReadOnly, Parm)
	int32                                        ChoiceID;                                          // 0x50(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
{
public:
	int32                                        ChoiceID;                                          // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
{
public:
	struct FChoiceData                           ChoiceItems;                                       // 0x0(0x30)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
};
...
public:
	...
	struct FChoiceData                           K2Node_Event_ChoiceItems;                          // 0x18(0x30)()
...
{
public:
	int32                                        SelectedChoice;                                    // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
