...
public:
	...
	struct FFortMultiSizeBrush                   CombatCategoryIcon;                                // 0x2D0(0x2D0)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FFortMultiSizeBrush                   BuildingCategoryIcon;                              // 0x5A0(0x2D0)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FFortMultiSizeBrush                   UtilityCategoryIcon;                               // 0x870(0x2D0)(Edit, BlueprintVisible, DisableEditOnInstance)
	enum class EFortBrushSize                    CategoryIconSize;                                  // 0xB40(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class EFortBrushSize                    BadgeIconSize;                                     // 0xB41(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_3BB8[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FMargin                               CategoriesMargin;                                  // 0xB44(0x10)(Edit, BlueprintVisible, NoDestructor)
	struct FMargin                               BarsMargin;                                        // 0xB54(0x10)(Edit, BlueprintVisible, NoDestructor)
	struct FMargin                               BarsIconMargin;                                    // 0xB64(0x10)(Edit, BlueprintVisible, NoDestructor)
	uint8                                        Pad_3BB9[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UFortUIMessageManager*                 MessageManager;                                    // 0xB78(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                        MaxScoreMessagesDisplayed;                         // 0xB80(0x4)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         bDisplayScoreStream;                               // 0xB84(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_3BBA[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        BarHeightOverride;                                 // 0xB88(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	void HandleMissionsUpdated(bool Temp_bool_True_if_break_was_hit_Variable, int32 Temp_int_Array_Index_Variable, bool CallFunc_Not_PreBool_ReturnValue, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, int32 Temp_int_Loop_Counter_Variable, bool CallFunc_IsValid_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, TArray<class AFortMission*>& CallFunc_GetAllLoadedMissions_ReturnValue, bool CallFunc_IsValid_ReturnValue2, class AFortMission* CallFunc_Array_Get_Item, bool CallFunc_IsValid_ReturnValue3, bool CallFunc_DoesImplementInterface_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue, bool CallFunc_BooleanAND_ReturnValue);
	void Construct();
	void Destruct();
