...
public:
	...
	uint8                                        Pad_1D3C[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FFortClientEvent                      K2Node_HandleClientEvent_ClientEvent2;             // 0x88(0x20)(NoDestructor)
	...
	struct FFortClientEvent                      K2Node_HandleClientEvent_ClientEvent;              // 0x130(0x20)(NoDestructor)
