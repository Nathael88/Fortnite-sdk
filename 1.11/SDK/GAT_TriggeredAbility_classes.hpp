...
public:
	...
	struct FGameplayTag                          TC_AbilitiesGenericTriggeredAbilityActivate;       // 0xAB8(0x8)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
