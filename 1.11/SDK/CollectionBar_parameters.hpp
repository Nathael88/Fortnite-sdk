...
{
public:
	struct FSlateBrush                           InIcon;                                            // 0x0(0x78)(BlueprintVisible, BlueprintReadOnly, Parm)
	class UHorizontalBoxSlot*                    K2Node_DynamicCast_AsHorizontal_Box_Slot;          // 0x78(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
