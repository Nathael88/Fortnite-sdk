...
public:
	...
	class AFortPawn*                             K2Node_Event_InteractingPawn;                      // 0x8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UDataAsset*                            K2Node_HandleMissionEvent_EventContent;            // 0x88(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FText                                  K2Node_HandleMissionEvent_GenericText;             // 0xA0(0x18)()
	struct FGameplayTagContainer                 K2Node_HandleMissionEvent_GameplayTags;            // 0xB8(0x20)()
	struct FFortMissionEvent                     K2Node_HandleMissionEvent_MissionEvent;            // 0xD8(0x98)()
	...
	struct FHitResult                            CallFunc_K2_SetWorldLocation_SweepHitResult;       // 0x230(0x80)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	struct FHitResult                            CallFunc_K2_SetWorldLocation_SweepHitResult2;      // 0x2B0(0x80)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	UInterfaceProperty_                          CallFunc_GiveItemToInventoryOwner_InventoryOwner_CastInput; // 0x330(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
