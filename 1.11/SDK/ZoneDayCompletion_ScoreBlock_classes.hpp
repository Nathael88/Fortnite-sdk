...
public:
	...
	class UAudioComponent*                       AC_ScoreCountLoop;                                 // 0x278(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
