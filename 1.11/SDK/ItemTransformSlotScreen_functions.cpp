...
void UItemTransformSlotScreen_C::SetupSlotScreen(int32 CallFunc_Array_Add_ReturnValue, int32 CallFunc_Array_Add_ReturnValue2, int32 CallFunc_Array_Add_ReturnValue3, int32 CallFunc_Array_Add_ReturnValue4, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, int32 CallFunc_Array_Add_ReturnValue5, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate2, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class UCommonButtonGroup* CallFunc_SpawnObject_ReturnValue)
{
...
// class UCommonButton*               K2Node_CustomEvent_AssociatedButton2                             (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// int32                              K2Node_CustomEvent_ButtonIndex2                                  (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UItemTransformSlotScreen_C::ExecuteUbergraph_ItemTransformSlotScreen(int32 EntryPoint, int32 CallFunc_GetSelectedButtonIndex_ReturnValue, class UItemTransformSlotEntry_C* CallFunc_Array_Get_Item, int32 K2Node_ComponentBoundEvent_SacrificePoints, int32 K2Node_ComponentBoundEvent_CurrentTier, class UFortItem* K2Node_ComponentBoundEvent_SelectedItem, bool K2Node_ComponentBoundEvent_TransformActive, class UCommonButton* K2Node_CustomEvent_AssociatedButton2, int32 K2Node_CustomEvent_ButtonIndex2, class UCommonButton* K2Node_CustomEvent_AssociatedButton, int32 K2Node_CustomEvent_ButtonIndex)
{
	...
	Parms.K2Node_CustomEvent_AssociatedButton2 = K2Node_CustomEvent_AssociatedButton2;
	Parms.K2Node_CustomEvent_ButtonIndex2 = K2Node_CustomEvent_ButtonIndex2;
