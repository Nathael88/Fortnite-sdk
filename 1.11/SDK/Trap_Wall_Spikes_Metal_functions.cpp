...
struct FTransform ATrap_Wall_Spikes_Metal_C::GetFireLocationAndRotation(const struct FTransform& CallFunc_K2_GetComponentToWorld_ReturnValue)
{
	static auto Func = Class->GetFunction("Trap_Wall_Spikes_Metal_C", "GetFireLocationAndRotation");

	Params::ATrap_Wall_Spikes_Metal_C_GetFireLocationAndRotation_Params Parms;
