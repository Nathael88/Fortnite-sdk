...
struct FTransform ATrap_Floor_Player_Jump_Pad_C::GetFireLocationAndRotation(const struct FTransform& CallFunc_K2_GetComponentToWorld_ReturnValue)
{
	static auto Func = Class->GetFunction("Trap_Floor_Player_Jump_Pad_C", "GetFireLocationAndRotation");

	Params::ATrap_Floor_Player_Jump_Pad_C_GetFireLocationAndRotation_Params Parms;
