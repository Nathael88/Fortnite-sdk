...
public:
	...
	struct FMargin                               SquadSlotPadding;                                  // 0x258(0x10)(Edit, BlueprintVisible, NoDestructor, ExposeOnSpawn)
	...
	struct FSlateBrush                           HeaderImageBrush;                                  // 0x2A8(0x78)(Edit, BlueprintVisible, ExposeOnSpawn)
	UMulticastDelegateProperty_                  HandleMouseEnter;                                  // 0x320(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	UMulticastDelegateProperty_                  HandleMouseLeave;                                  // 0x330(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
