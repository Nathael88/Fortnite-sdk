...
{
public:
	bool                                         bViewOnly;                                         // 0x0(0x1)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
...
{
public:
	class FText                                  EULA;                                              // 0x0(0x18)(BlueprintVisible, BlueprintReadOnly, Parm)
};
