...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// int32                              New_Rating_Value                                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UPowerWidget_C::ExecuteUbergraph_PowerWidget(int32 EntryPoint, bool CallFunc_SetState_PassThrough, const struct FFortTeamMemberInfo& K2Node_Event_NewInfo, class UFortPartyContext* CallFunc_GetContext_ReturnValue, enum class EFortPartyMemberDisplayState CallFunc_GetPartyMemberDisplayState_ReturnValue, bool K2Node_SwitchEnum_CmpSuccess)
{
