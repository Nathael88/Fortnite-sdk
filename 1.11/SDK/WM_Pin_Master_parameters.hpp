...
{
public:
	TArray<class UFortQuestItem*>                QuestItems;                                        // 0x0(0x10)(BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm)
};
...
{
public:
	class FString                                PreviewedTheaterId;                                // 0x0(0x10)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
};
...
public:
	...
	struct FFortTheaterMapData                   CallFunc_GetTheaterData_OutTheaterData;            // 0x28(0x4D0)()
	bool                                         CallFunc_GetTheaterData_ReturnValue;               // 0x4F8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_42C8[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FText                                  CallFunc_GetRequirementText_ReturnValue;           // 0x500(0x18)()
};
...
public:
	...
	struct FFortTheaterMapData                   CallFunc_GetTheaterData_OutTheaterData;            // 0x10(0x4D0)()
	bool                                         CallFunc_GetTheaterData_ReturnValue;               // 0x4E0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_42CA[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class APlayerController*                     CallFunc_GetPlayerController_ReturnValue;          // 0x4E8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AFortPlayerController*                 K2Node_DynamicCast_AsFort_Player_Controller;       // 0x4F0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess;                       // 0x4F8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_IsRequirementsMet_ReturnValue;            // 0x4F9(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
{
public:
	class AActor*                                TouchedActor;                                      // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
