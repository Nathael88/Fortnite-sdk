...
{
public:
	struct FGameplayCueParameters                GameplayCueParameters;                             // 0x0(0xB8)(BlueprintVisible, BlueprintReadOnly, Parm, ContainsInstancedReference)
	bool                                         TeleportOut_;                                      // 0xB8(0x1)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_304D[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        Default_PlayLength;                                // 0xBC(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_304E[0xE];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_3052[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
