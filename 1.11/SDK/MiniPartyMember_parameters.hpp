...
{
public:
	struct FFortTeamMemberInfo                   NewMemberInfo;                                     // 0x0(0x1A8)(BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
...
public:
	...
	struct FFortTeamMemberInfo                   K2Node_Event_NewInfo;                              // 0x8(0x1A8)()
	class UCommonButton*                         K2Node_ComponentBoundEvent_Button3;                // 0x1B0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UCommonButton*                         K2Node_ComponentBoundEvent_Button2;                // 0x1B8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
