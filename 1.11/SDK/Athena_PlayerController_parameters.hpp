...
public:
	...
	struct FFortTeamMemberInfo                   CallFunc_GetLocalTeamTeamMemberInfo_TeamMemberInfo; // 0x18(0x1A8)()
	bool                                         CallFunc_GetLocalTeamTeamMemberInfo_ReturnValue;   // 0x1C0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_IsTeamMemberFriend_ReturnValue;           // 0x1C1(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
public:
	...
	uint8                                        Pad_3464[0xB];                                     // Fixing Size After Last Property  [ Dumper-7 ]
