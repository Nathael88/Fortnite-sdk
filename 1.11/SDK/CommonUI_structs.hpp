...
public:
	...
	uint8                                        Pad_249E[0x6];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	struct FSlateBrush                           PlatformSpecificBrush;                             // 0x0(0x78)(Edit, NativeAccessSpecifierPublic)
	uint8                                        Pad_249F[0x168];                                   // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	struct FCommonInputKeyDisplayData            Value;                                             // 0x18(0x1E0)(Edit, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_24A0[0x48];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FSlateBrush                           InputTypeOverrideBrush;                            // 0x88(0x78)(Edit, NativeAccessSpecifierPublic)
	uint8                                        Pad_24A2[0x168];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	bool                                         bActionRequiresHold;                               // 0x268(0x1)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_24A3[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        HoldTime;                                          // 0x26C(0x4)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
