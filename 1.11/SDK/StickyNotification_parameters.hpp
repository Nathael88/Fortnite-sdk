...
public:
	...
	bool                                         K2Node_ComponentBoundEvent_Is_Hovered;             // 0x130(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_IsAnimationPlaying_ReturnValue;           // 0x131(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_3E10[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UFortBaseButton*                       K2Node_ComponentBoundEvent_Button;                 // 0x138(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
