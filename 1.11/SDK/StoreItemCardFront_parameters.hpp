...
public:
	...
	struct FSlateBrush                           CallFunc_GetTertiaryCategory_ItemCategoryBrush;    // 0x1D0(0x78)()
	...
	class FText                                  CallFunc_Conv_StringToText_ReturnValue;            // 0x250(0x18)()
	struct FFormatArgumentData                   K2Node_MakeStruct_FormatArgumentData;              // 0x268(0x40)(HasGetValueTypeHash)
	enum class EFortInventoryFilter              CallFunc_GetFilterCategory_ReturnValue;            // 0x2A8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FText                                  K2Node_Select_Default;                             // 0x2D0(0x18)()
	class FText                                  CallFunc_TextTrimPrecedingAndTrailing_ReturnValue; // 0x2E8(0x18)()
	struct FFormatArgumentData                   K2Node_MakeStruct_FormatArgumentData2;             // 0x300(0x40)(HasGetValueTypeHash)
	TArray<struct FFormatArgumentData>           K2Node_MakeArray_Array;                            // 0x340(0x10)(ZeroConstructor, ReferenceParm)
	class FText                                  CallFunc_Format_ReturnValue;                       // 0x350(0x18)()
	class FText                                  K2Node_Select2_Default;                            // 0x368(0x18)()
};
