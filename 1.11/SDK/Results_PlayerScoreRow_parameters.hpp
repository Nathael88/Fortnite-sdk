...
public:
	...
	TArray<enum class EFortUIScoreType>          K2Node_MakeArray_Array2;                           // 0x68(0x10)(ZeroConstructor, ReferenceParm)
	enum class EFortUIScoreType                  CallFunc_Array_Get_Item2;                          // 0x78(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
