...
public:
	...
	enum class ESlateVisibility                  CallFunc_GetVisibility_ReturnValue2;               // 0xA7(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	enum class ESlateVisibility                  Temp_byte_Variable2;                               // 0xAC(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                         CallFunc_Greater_FloatFloat_ReturnValue;           // 0x152(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_2ADC[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FLinearColor                          K2Node_Select2_Default;                            // 0x154(0x10)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
