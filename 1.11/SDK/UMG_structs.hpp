...
{
public:
	uint8                                        Pad_1F4E[0xB8];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1F50[0x2];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1F51[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1F53[0x70];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1F54[0x70];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	struct FRichCurve                            Shear;                                             // 0x278(0x70)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_1F55[0x70];                                    // Fixing Size After Last Property  [ Dumper-7 ]
