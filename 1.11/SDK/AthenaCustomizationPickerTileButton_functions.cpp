...
{
	static auto Func = Class->GetFunction("AthenaCustomizationPickerTileButton_C", "SetSelected");

	Params::UAthenaCustomizationPickerTileButton_C_SetSelected_Params Parms;
...
void UAthenaCustomizationPickerTileButton_C::ExecuteUbergraph_AthenaCustomizationPickerTileButton(int32 EntryPoint, bool K2Node_Event_bSelected, bool Temp_bool_Variable, class UObject* K2Node_Event_InData, class UCommonListView* K2Node_Event_OwningList, bool CallFunc_IsValid_ReturnValue, class UWidget* K2Node_Select_Default)
{
