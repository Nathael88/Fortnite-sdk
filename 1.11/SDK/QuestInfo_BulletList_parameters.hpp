...
public:
	...
	struct FSlateBrush                           EntryIconBrush;                                    // 0x18(0x78)(BlueprintVisible, BlueprintReadOnly, Parm)
	class UQuestInfo_BulletListEntry_C*          NewEntry;                                          // 0x90(0x8)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UQuestInfo_BulletListEntry_C*          CallFunc_Create_ReturnValue;                       // 0x98(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
