...
{
public:
	struct FSlateBrush                           CallFunc_ResizeBrush_NewParam;                     // 0x0(0x78)()
	class UFortAlterationItemDefinition*         CallFunc_GetAlterationDefintion_ReturnValue;       // 0x78(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
