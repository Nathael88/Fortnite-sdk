...
// struct FVector                     CallFunc_GetRightVector_ReturnValue2                             (IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UBulletWhipTrackerComponent_C::PlayWhipSound(const struct FVector& Location, const struct FVector& CallFunc_GetRightVector_ReturnValue, const struct FVector& CallFunc_GetRightVector_ReturnValue2, const struct FVector& CallFunc_K2_GetComponentLocation_ReturnValue, float CallFunc_BreakVector_X, float CallFunc_BreakVector_Y, float CallFunc_BreakVector_Z, const struct FVector& CallFunc_MakeVector_ReturnValue, float CallFunc_Subtract_FloatFloat_ReturnValue, const struct FVector& CallFunc_Normal_ReturnValue, float CallFunc_BreakVector_X2, float CallFunc_BreakVector_Y2, float CallFunc_BreakVector_Z2, const struct FVector& CallFunc_MakeVector_ReturnValue2, float CallFunc_Dot_VectorVector_ReturnValue, float CallFunc_RadiansToDegrees_ReturnValue, const struct FVector& CallFunc_RotateAngleAxis_ReturnValue, const struct FVector& CallFunc_Multiply_VectorFloat_ReturnValue, const struct FVector& CallFunc_Add_VectorVector_ReturnValue)
{
	...
	Parms.CallFunc_GetRightVector_ReturnValue2 = CallFunc_GetRightVector_ReturnValue2;
...
class USceneComponent* UBulletWhipTrackerComponent_C::GetLocalPawnForTracking(class AActor* CallFunc_GetOwner_ReturnValue, TArray<class AFortPlayerController*>& CallFunc_GetLocalFortPlayerControllers_ReturnValue, class APawn* CallFunc_GetInstigator_ReturnValue, class AFortPlayerController* CallFunc_Array_Get_Item, int32 CallFunc_Array_Length_ReturnValue, class ASpectatorPawn* CallFunc_GetSpectatorPawn_ReturnValue, bool CallFunc_Greater_IntInt_ReturnValue, class USceneComponent* CallFunc_K2_GetRootComponent_ReturnValue, bool CallFunc_IsValid_ReturnValue, class AFortPlayerPawn* CallFunc_GetPlayerPawn_ReturnValue, class USceneComponent* CallFunc_K2_GetRootComponent_ReturnValue2, bool CallFunc_IsValid_ReturnValue2, bool CallFunc_NotEqual_ObjectObject_ReturnValue)
{
...
// class USceneComponent*             CallFunc_GetLocalPawnForTracking_ReturnValue                     (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_IsValid_ReturnValue                                     (ZeroConstructor, IsPlainOldData, NoDestructor)
// class AActor*                      CallFunc_GetOwner_ReturnValue                                    (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UBulletWhipTrackerComponent_C::TrackWhipStatus(bool* Changed, float* Whip_Distance, bool ChangedResult, const struct FVector& CallFunc_K2_GetComponentLocation_ReturnValue, const struct FVector& CallFunc_K2_GetComponentLocation_ReturnValue2, class USceneComponent* CallFunc_GetLocalPawnForTracking_ReturnValue, bool CallFunc_IsValid_ReturnValue, class AActor* CallFunc_GetOwner_ReturnValue, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue, const struct FVector& CallFunc_Subtract_VectorVector_ReturnValue, const struct FVector& CallFunc_Subtract_VectorVector_ReturnValue2, const struct FVector& CallFunc_K2_GetComponentLocation_ReturnValue3, const struct FVector& CallFunc_ProjectVectorOnToVector_ReturnValue, const struct FVector& CallFunc_Add_VectorVector_ReturnValue, float CallFunc_Dot_VectorVector_ReturnValue, const struct FVector& CallFunc_Subtract_VectorVector_ReturnValue3, float CallFunc_SignOfFloat_ReturnValue, float CallFunc_VSize_ReturnValue, bool CallFunc_NotEqual_FloatFloat_ReturnValue)
{
...
void UBulletWhipTrackerComponent_C::ExecuteUbergraph_BulletWhipTrackerComponent(int32 EntryPoint, bool CallFunc_Not_PreBool_ReturnValue, float K2Node_Event_DeltaSeconds, bool CallFunc_LessEqual_FloatFloat_ReturnValue, bool CallFunc_TrackWhipStatus_Changed, float CallFunc_TrackWhipStatus_Whip_Distance, float CallFunc_MapRangeClamped_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, float CallFunc_Subtract_FloatFloat_ReturnValue, const struct FVector& K2Node_CustomEvent_StartLocation, bool CallFunc_TrackWhipStatus_Changed2, float CallFunc_TrackWhipStatus_Whip_Distance2, const struct FVector& K2Node_CustomEvent_Current_Velocity)
{
