...
public:
	...
	uint8                                        Pad_282F[0xF];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class UParticleSystemComponent*              CallFunc_SpawnParticleSystemOnCharacterMesh_PSComponentReference; // 0x170(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
