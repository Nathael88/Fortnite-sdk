...
{
public:
	class UCommonButton*                         AddedButton;                                       // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	struct FCommonInputActionHandlerData         K2Node_Event_Data;                                 // 0x10(0x18)(NoDestructor)
