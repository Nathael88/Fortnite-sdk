...
public:
	...
	class UCommonTextBlock*                      Tab_Tooltip_Text;                                  // 0x250(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
