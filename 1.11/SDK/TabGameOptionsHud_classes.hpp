...
public:
	...
	class UCommonTextBlock*                      TooltipDisplayReference;                           // 0x288(0x8)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
