...
{
public:
	struct FTimespan                             Timespan;                                          // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, NoDestructor, HasGetValueTypeHash)
...
{
public:
	struct FSlateBrush                           InBrush;                                           // 0x0(0x78)(BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
};
