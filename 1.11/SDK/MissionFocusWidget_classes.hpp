...
public:
	...
	class UFortMissionTimerComponent*            SavedTimerComponent;                               // 0x230(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
