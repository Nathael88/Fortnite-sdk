...
public:
	...
	class UParticleSystemComponent*              JumpParticleSystem;                                // 0xE90(0x8)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
