...
public:
	...
	class FText                                  Temp_text_Variable2;                               // 0x100(0x18)()
	class FText                                  Temp_text_Variable3;                               // 0x118(0x18)()
	...
	class FText                                  Temp_text_Variable4;                               // 0x150(0x18)()
	class FText                                  Temp_text_Variable5;                               // 0x168(0x18)()
	class FText                                  Temp_text_Variable6;                               // 0x180(0x18)()
	...
	class FText                                  CallFunc_Conv_IntToText_ReturnValue2;              // 0x1B8(0x18)()
	bool                                         Temp_bool_Variable3;                               // 0x1D0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_406A[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FText                                  K2Node_Select3_Default;                            // 0x1D8(0x18)()
};
