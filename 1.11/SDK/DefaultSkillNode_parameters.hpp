...
public:
	...
	uint8                                        Pad_3D5E[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_3D5F[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	class UMaterialInstanceDynamic*              CallFunc_GetSingleMaterialStyleMID_ReturnValue;    // 0x0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FFortSkillTreeNodeDisplayData         CallFunc_TryGetNodeDisplayData_OutDisplayData;     // 0x8(0x2D8)()
	bool                                         CallFunc_TryGetNodeDisplayData_ReturnValue;        // 0x2E0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_3D60[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FHomebaseNode                         CallFunc_TryGetStaticSkillTreeNodeData_OutNodeData; // 0x2E8(0xC0)()
	bool                                         CallFunc_TryGetStaticSkillTreeNodeData_ReturnValue; // 0x3A8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	float                                        CallFunc_GetSkillTreeNodeSizeByMagnitude_Size;     // 0x3AC(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector2D                             CallFunc_MakeVector2D_ReturnValue;                 // 0x3B0(0x8)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
