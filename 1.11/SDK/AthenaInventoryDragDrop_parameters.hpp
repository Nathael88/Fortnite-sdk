...
public:
	...
	class UAthenaInventoryDragVisual_C*          K2Node_DynamicCast_AsAthena_Inventory_Drag_Visual; // 0x8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
