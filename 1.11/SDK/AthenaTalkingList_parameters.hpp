...
public:
	...
	class FText                                  CallFunc_Conv_StringToText_ReturnValue2;           // 0x30(0x18)()
	class FText                                  CallFunc_Conv_StringToText_ReturnValue3;           // 0x48(0x18)()
	class FText                                  CallFunc_Conv_StringToText_ReturnValue4;           // 0x60(0x18)()
	bool                                         CallFunc_Array_IsValidIndex_ReturnValue;           // 0x78(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_Array_IsValidIndex_ReturnValue2;          // 0x79(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_Array_IsValidIndex_ReturnValue3;          // 0x7A(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_385B[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FText                                  CallFunc_Conv_StringToText_ReturnValue5;           // 0x80(0x18)()
	bool                                         CallFunc_Array_IsValidIndex_ReturnValue4;          // 0x98(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_Array_IsValidIndex_ReturnValue5;          // 0x99(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
