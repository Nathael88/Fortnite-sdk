...
public:
	...
	class UBP_LocalPlayerProfileModal_C*         NewLocalPlayerWidget;                              // 0x260(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
