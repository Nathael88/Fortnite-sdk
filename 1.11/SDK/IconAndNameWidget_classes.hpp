...
public:
	...
	struct FSlateBrush                           Brush;                                             // 0x238(0x78)(Edit, BlueprintVisible, ExposeOnSpawn)
	class FText                                  Text;                                              // 0x2B0(0x18)(Edit, BlueprintVisible, ExposeOnSpawn)
	class UClass*                                BorderStyle;                                       // 0x2C8(0x8)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	bool                                         bBorderVisible;                                    // 0x2D0(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn)
	bool                                         bMatches;                                          // 0x2D1(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn)
	bool                                         bBorderColorOverride;                              // 0x2D2(0x1)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	uint8                                        Pad_3874[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FLinearColor                          RGBA0;                                             // 0x2D4(0x10)(Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
