...
// TArray<class FName>                K2Node_MakeArray_Array3                                          (ZeroConstructor, ReferenceParm)
// class FName                        CallFunc_Array_Get_Item7                                         (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AImpactNumbers_C::Set_Material_Pararmeters(struct FFortDamageNumberInfo& NewDamageHitInfoStruct, const struct FTransform& CameraTransform, const struct FVector& NumberLocation, float OffsetAccumulatedValue, float RealGameTime, const struct FVector& CallFunc_BreakTransform_Location, const struct FRotator& CallFunc_BreakTransform_Rotation, const struct FVector& CallFunc_BreakTransform_Scale, const struct FVector& CallFunc_Subtract_VectorVector_ReturnValue, int32 CallFunc_Array_LastIndex_ReturnValue, float CallFunc_VSize_ReturnValue, int32 CallFunc_Array_LastIndex_ReturnValue2, int32 CallFunc_Array_LastIndex_ReturnValue3, int32 CallFunc_Array_LastIndex_ReturnValue4, float CallFunc_Conv_IntToFloat_ReturnValue, int32 CallFunc_Array_LastIndex_ReturnValue5, int32 CallFunc_Array_Length_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, float CallFunc_Multiply_IntFloat_ReturnValue, bool CallFunc_Greater_IntInt_ReturnValue, float CallFunc_Add_FloatFloat_ReturnValue, int32 CallFunc_Array_Length_ReturnValue2, bool CallFunc_EqualEqual_ByteByte_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue2, bool CallFunc_BooleanAND_ReturnValue, float CallFunc_SelectFloat_ReturnValue, float CallFunc_Conv_BoolToFloat_ReturnValue, float CallFunc_Multiply_FloatFloat_ReturnValue, float CallFunc_Conv_BoolToFloat_ReturnValue2, int32 Temp_int_Array_Index_Variable, float CallFunc_Divide_FloatFloat_ReturnValue, class UMaterialInstanceDynamic* CallFunc_Array_Get_Item, float CallFunc_FClamp_ReturnValue, float CallFunc_FClamp_ReturnValue2, float CallFunc_SelectFloat_ReturnValue2, float CallFunc_Lerp_ReturnValue, float CallFunc_Multiply_FloatFloat_ReturnValue2, float CallFunc_RandomFloatInRange_ReturnValue, float CallFunc_Multiply_FloatFloat_ReturnValue3, float CallFunc_Multiply_FloatFloat_ReturnValue4, float CallFunc_Multiply_FloatFloat_ReturnValue5, float CallFunc_Multiply_FloatFloat_ReturnValue6, float CallFunc_Multiply_FloatFloat_ReturnValue7, int32 Temp_int_Variable, int32 CallFunc_Clamp_ReturnValue, const struct FLinearColor& CallFunc_SelectColor_ReturnValue, int32 CallFunc_Array_Get_Item2, int32 CallFunc_Subtract_IntInt_ReturnValue, bool CallFunc_EqualEqual_IntInt_ReturnValue, int32 CallFunc_Clamp_ReturnValue2, int32 CallFunc_Clamp_ReturnValue3, int32 CallFunc_Array_Get_Item3, int32 CallFunc_Array_Get_Item4, bool CallFunc_EqualEqual_IntInt_ReturnValue2, float CallFunc_Conv_IntToFloat_ReturnValue2, bool CallFunc_BooleanOR_ReturnValue, bool CallFunc_EqualEqual_IntInt_ReturnValue3, float CallFunc_SelectFloat_ReturnValue3, bool CallFunc_BooleanAND_ReturnValue2, float CallFunc_Add_FloatFloat_ReturnValue2, bool CallFunc_NotEqual_IntInt_ReturnValue, bool CallFunc_BooleanOR_ReturnValue2, float CallFunc_Conv_IntToFloat_ReturnValue3, bool CallFunc_LessEqual_IntInt_ReturnValue, float CallFunc_Divide_FloatFloat_ReturnValue2, bool CallFunc_BooleanAND_ReturnValue3, float CallFunc_Subtract_FloatFloat_ReturnValue, float CallFunc_Conv_BoolToFloat_ReturnValue3, float CallFunc_Multiply_FloatFloat_ReturnValue8, float CallFunc_Multiply_FloatFloat_ReturnValue9, const struct FVector& CallFunc_MakeVector_ReturnValue, float CallFunc_Multiply_FloatFloat_ReturnValue10, const struct FVector& CallFunc_TransformDirection_ReturnValue, float CallFunc_BreakVector_X, float CallFunc_BreakVector_Y, float CallFunc_BreakVector_Z, float CallFunc_BreakVector_X2, float CallFunc_BreakVector_Y2, float CallFunc_BreakVector_Z2, const struct FLinearColor& K2Node_MakeStruct_LinearColor, float CallFunc_SignOfFloat_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue2, const struct FLinearColor& CallFunc_SelectColor_ReturnValue2, float CallFunc_Add_FloatFloat_ReturnValue3, const struct FLinearColor& CallFunc_SelectColor_ReturnValue3, const struct FLinearColor& K2Node_MakeStruct_LinearColor2, int32 Temp_int_Variable2, bool Temp_bool_Variable, int32 K2Node_Select_Default, float CallFunc_GetScalarParameterValue_ReturnValue, bool CallFunc_LessEqual_IntInt_ReturnValue2, TArray<class FName>& K2Node_MakeArray_Array, class FName CallFunc_Array_Get_Item5, float CallFunc_Multiply_FloatFloat_ReturnValue11, const struct FLinearColor& K2Node_MakeStruct_LinearColor3, int32 Temp_int_Loop_Counter_Variable, TArray<class FName>& K2Node_MakeArray_Array2, class FName CallFunc_Array_Get_Item6, bool CallFunc_Less_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue3, TArray<class FName>& K2Node_MakeArray_Array3, class FName CallFunc_Array_Get_Item7)
{
...
// enum class EFortDamageNumberType   Temp_byte_Variable2                                              (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// struct FFortDamageNumberInfo       K2Node_Event_NewDamageNumberInfo                                 (ContainsInstancedReference)
