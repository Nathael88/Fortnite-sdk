...
void UMinibossDetails_C::Kill(bool CallFunc_IsAnimationPlaying_ReturnValue, bool CallFunc_IsAnimationPlaying_ReturnValue2, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, bool CallFunc_IsVisible_ReturnValue)
{
...
void UMinibossDetails_C::Outro(bool CallFunc_IsAnimationPlaying_ReturnValue, bool CallFunc_IsAnimationPlaying_ReturnValue2, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, bool CallFunc_IsVisible_ReturnValue)
{
...
void UMinibossDetails_C::Intro(bool CallFunc_IsAnimationPlaying_ReturnValue, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, bool CallFunc_IsAnimationPlaying_ReturnValue2)
{
...
void UMinibossDetails_C::InitializeMiniBossDetails(TArray<class FText>& InModifiers, class FText InName, class FText InUpgradeName, float InHealthPercent, bool ShowName, bool ShowPortrait, class UClass* NameStyle, class UClass* ModifiersStyle, enum class ETextJustify Name_Alignment, enum class ETextJustify Modifiers_Alignment, float Health_Bar_Width, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable2, bool CallFunc_TextIsEmpty_ReturnValue, bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable3, enum class ESlateVisibility Temp_byte_Variable4, bool Temp_bool_Variable2, enum class ESlateVisibility K2Node_Select_Default, enum class ESlateVisibility K2Node_Select2_Default)
{
...
// float                              CallFunc_GetHUDTargetHealthPercentage_ReturnValue2               (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UMinibossDetails_C::ExecuteUbergraph_MinibossDetails(int32 EntryPoint, float CallFunc_GetHUDTargetHealthPercentage_ReturnValue, float CallFunc_GetHUDTargetHealthPercentage_ReturnValue2, class FText CallFunc_GetHUDTargetUpgradeDisplayName_ReturnValue, class FText CallFunc_GetHUDTargetDisplayName_ReturnValue, TArray<class FText>& CallFunc_GetHUDTargetDisplayModifiers_ReturnValue, class UObject* CallFunc_Conv_InterfaceToObject_ReturnValue, bool CallFunc_IsValid_ReturnValue, class UObject* CallFunc_Conv_InterfaceToObject_ReturnValue2, bool CallFunc_IsValid_ReturnValue2, bool CallFunc_IsVisible_ReturnValue)
{
	...
	Parms.CallFunc_GetHUDTargetHealthPercentage_ReturnValue2 = CallFunc_GetHUDTargetHealthPercentage_ReturnValue2;
