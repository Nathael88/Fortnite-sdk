...
public:
	...
	enum class EFortStatValueDisplayType         Temp_byte_Variable;                                // 0x230(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	enum class EFortBuffState                    Temp_byte_Variable2;                               // 0x254(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
