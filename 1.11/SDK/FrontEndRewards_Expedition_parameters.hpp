...
public:
	...
	struct FFortTagUIData                        CallFunc_GetUIDataForTag_OutData;                  // 0x10(0x308)()
	bool                                         CallFunc_GetUIDataForTag_ReturnValue;              // 0x318(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
public:
	...
	class UFortExpeditionItem*                   K2Node_Event_Expedition;                           // 0x8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<struct FFortItemInstanceQuantityPair> K2Node_Event_Rewards;                              // 0x18(0x10)(ZeroConstructor, ReferenceParm)
